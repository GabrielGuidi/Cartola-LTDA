...
{
    public class ByPriceWithOnlyHomeAndNoOpponentsStrategy : IBestPlayerStrategy
    {
        public bool CalculateWithOnlyHomePlayers => true;
        public bool AllowOpponents => false;
        public Func<JogadorHistorico, decimal> FunctionWorstPlayer => x => x.PrecoNum;
        public string Name => "By price [OnlyHome|NoOppents]";
